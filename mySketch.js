...
function setup() {
  ...
  describeElement("canvas", "A potato with eyes that, when pressed, make different sounds. These sounds are based on musical notes but actually made by singing variations of potato in a closet during covid lockdown.");
  
  // Announce keyboard support
  createElement('p', 'You can interact with this potato by clicking eyes or by pressing the keys 1 to 8 on your keyboard to toggle sounds.');
